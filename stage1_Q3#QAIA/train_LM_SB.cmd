...
:pReg_LM_SB
python train_LM_SB.py -M pReg_LM_SB
python train_LM_SB.py -M pReg_LM_SB --overfit
...
python train_LM_SB.py -M ppReg_LM_SB --overfit --load log\DU-LM-SB_T=10_lr=0.01_overfit.pth --lr 0.005

:pppReg_LM_SB
python train_LM_SB.py -M pppReg_LM_SB
python train_LM_SB.py -M pppReg_LM_SB --overfit
